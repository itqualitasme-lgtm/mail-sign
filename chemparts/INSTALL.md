# Chemparts Email Signature — Installation Guide
...
5. Give it the name `Chemparts` and select the email account it applies to.
...
9. Under **Signature Settings**, set the new `Chemparts` signature as the default for the account.
10. Click **Save**.
...
4. Click **+ New signature**, name it `Chemparts`.
5. Click in the edit box and **Ctrl + V** to paste.
6. Under **Select default signatures**, set Chemparts for both new messages and replies.
7. **Save**.
...
3. Scroll down to **Signature**, click **+ Create new**, name it `Chemparts`.
4. Click in the edit box and **Ctrl + V** to paste.
5. Under **Signature defaults**, pick Chemparts for **For New Emails Use** and **On Reply/Forward Use**.
...
3. Pick your account, click **+** to add a new signature, name it `Chemparts`.
...
6. At the bottom, set **Choose Signature** to Chemparts.
7. Close the window.
...
Contact IT: **info@chemparts-me.com**
